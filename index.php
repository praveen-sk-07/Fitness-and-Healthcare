...
<body onload="myFunction()" style="margin:0;">
  ...
  <div class="personal" id="Personal-id">
    ...
    <div class="card mb-3 tej-card" style="max-width: 540px;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="Pictures/me2.png" class="img-fluid rounded-start" alt="..." style="height:100%;">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">TEAM</h5>
            <p class="card-text"> We the brilliant engineering students with a passion for innovation and a knack for coding.
